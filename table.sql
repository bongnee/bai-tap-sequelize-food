...
#caau1: tìm 5 người like nhà hàng nhiều nhất
...
ALTER TABLE orders ADD CONSTRAINT orders_food_id_fkey FOREIGN KEY(food_id) REFERENCES food(food_id) ON DELETE RESTRICT ON UPDATE CASCADE;
